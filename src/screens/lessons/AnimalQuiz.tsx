...
const QUESTIONS: Question[] = [
  ...
  {
    id: 4,
    prompt: 'Complete the sentence: "I saw a ___ at the farm."',
    sentence: '"I saw a ___ at the farm."',
    options: [
      { videoKey: 'dog', correct: false },
      { videoKey: 'rabbit', correct: true },
      { videoKey: 'fish', correct: false },
    ],
    explanation: 'Rabbits are commonly found on farms.',
  },
  {
    id: 5,
  ...
  {
    id: 7,
    prompt: 'Which is a common pet animal?',
    options: [
      { videoKey: 'fish', correct: false },
      { videoKey: 'cat', correct: true },
      { videoKey: 'rabbit', correct: false },
    ],
    explanation: 'Cats are one of the most popular pet animals.',
  },
  {
    id: 8,
  ...
  {
    id: 10,
    prompt: 'Which video shows the sign for "fish"?',
    options: [
      { videoKey: 'rabbit', correct: false },
      { videoKey: 'cat', correct: false },
      { videoKey: 'fish', correct: true },
    ],
    explanation: 'Fish is signed with fingers opening and closing like a fish mouth.',
  },
  {
    id: 11,
    prompt: 'Which animal does this sign represent?',
    ...
    explanation: 'This sign shows a dog with a patting and snapping motion.',
  },
];
